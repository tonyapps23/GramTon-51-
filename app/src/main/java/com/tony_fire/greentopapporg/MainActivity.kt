...
import com.tony_fire.greentopapporg.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun videoPlayer() {
        val mediaItem: MediaItem = MediaItem.fromUri("http://video.pr0gram1.xyz/video/greenton/greenton.m3u8")
        binding.videoView.player = player
