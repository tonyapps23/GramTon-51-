...
import com.tony_fire.greentopapporg.databinding.ActivityRegistrationBinding
...
class RegistrationActivity : AppCompatActivity() {
    ...
    private fun userField() {
        binding.regButton.setOnClickListener {
            ...
            val userinfo = UserInfo(countrypicker,ed_email,ed1stName,"5f9955e25cb3ff75e3cfcce8",ed2stName,ed_tel,"tonprgrmqs")
